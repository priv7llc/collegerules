      ...
      <Card>
        ...
        <CardContent>
          <Accordion type="single" collapsible>
            <AccordionItem value="1"><AccordionTrigger>How do I create a new route?</AccordionTrigger><AccordionContent>Click "Create Route" from your dashboard. Creating a route is free — there's no limit on how many you can build.</AccordionContent></AccordionItem>
