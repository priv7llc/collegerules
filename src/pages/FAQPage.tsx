...
const faqs = [
  ...
  { q: 'Is this a subscription?', a: 'No. Creating routes is free, and unlocks are a one-time payment that never expires.' },
  ...
  { q: 'Can I get a refund?', a: 'We offer refunds within 7 days of purchase if you haven\'t used your unlocks. Contact support for assistance.' },
